<template>
  <div class="search-container">
    <button v-if="$route.name === 'ParkingDetail' || booking" class="back-button" @click="clearSelectedParking">
